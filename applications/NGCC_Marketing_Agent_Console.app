...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        ...
        <liveAgentConfig>
            ...
            <pageNamesToOpen>NGCC_MODS_SFDC_Contact_Search</pageNamesToOpen>
    ...
    <label>Marketing Agent Console</label>
    <preferences>
    ...
    <tabs>Inbound_Call</tabs>
    <tabs>standard-Contact</tabs>
    <tabs>standard-report</tabs>
    <tabs>standard-OmniSupervisor</tabs>
    <tabs>CC_PreChat_Option__c</tabs>
    <tabs>Queue_Members_Management_Tool</tabs>
    <tabs>standard-LiveAgentSupervisor</tabs>
    <tabs>Customer_Engagement_Calendar</tabs>
    <tabs>Requalification_Report</tabs>
